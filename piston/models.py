...
class Consumer(models.Model):
    ...
    user = models.ForeignKey(User, models.CASCADE, null=True, blank=True, related_name='consumers')
...
class Token(models.Model):
    ...
    user = models.ForeignKey(User, models.CASCADE, null=True, blank=True, related_name='tokens')
