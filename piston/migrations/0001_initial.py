    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(related_name='consumers', on_delete=models.CASCADE, blank=True, to=settings.AUTH_USER_MODEL, null=True)),
            ],
        ),
        migrations.CreateModel(
            name='Nonce',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('consumer', models.ForeignKey(to='piston.Consumer', on_delete=models.CASCADE)),
                ('user', models.ForeignKey(related_name='tokens', on_delete=models.CASCADE, blank=True, to=settings.AUTH_USER_MODEL, null=True)),
            ],
        ),
    ]
